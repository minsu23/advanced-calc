...
#line 75 "fb3-2.y"
                       ...
                       printf("Defined %s\n> ", (yyvsp[-6].s)->name); }
#line 1268 "fb3-2.tab.c"
    break;

  case 28: /* calclist: calclist error EOL  */
#line 79 "fb3-2.y"
                       { yyerrok; printf("> "); }
#line 1274 "fb3-2.tab.c"
    break;
